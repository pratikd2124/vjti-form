      ...
      <div className="section about-section gray-bg" id="about">
            <div className="container">
                  ...
                  <div className="col-lg-6">
                        <div className="about-avatar mx-2">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Tata_logo.svg/2231px-Tata_logo.svg.png" width="300" height="300"title="" alt=""/>
                        </div>
                    </div>
                    <div className="col-lg-6">
                        <div className="about-text go-to">
                            <h3 className="dark-color p-2">About Me</h3>
