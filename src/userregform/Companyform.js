        ...
        <>
            ...
            <form>
                <div className="form-group col-md-5 mx-auto py-1 ">
                    <label for="name" className="h5">Company Name</label>
                    <input type="text" onChange={handleChange} className="form-control" id="name" aria-describedby="" name="name" placeholder="Enter Organization name" />
                </div>
                <div className="form-group col-md-5 mx-auto  py-1 ">
                ...
                <p className="text-center text-muted mt-5 mb-0" style={{ "padding": "10px" }}>Have already an account? <a href="/login"
